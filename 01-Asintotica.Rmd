...
```{theorem, label="t9"}
Si $X_1,...,X_n$ independientes y cada $X_i$
tiene uno de los tres tipos de distribución extremal, entonces la distribución del $max(X_1,...,X_n)$ es:
...
está en el $DAM$ Gumbel. Finalmente, si $X_1,...,X_k$
$iid$ con distribución $F$, calcular las sucesiones de
reales, $d_n$ y $c_n>0$, tales que la distribución de
$\frac{max(X_1,...,X_n)- d_n}{c_n}\rightarrow \Lambda$ cuando $n\rightarrow \infty$.
